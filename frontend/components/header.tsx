    ...
    <header className="w-full bg-transparent">
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-400 text-white shadow-lg shadow-blue-500/20">
      ...
      {mobileMenuOpen && (
        <div className="absolute top-20 left-4 right-4 z-50 flex flex-col gap-2 p-2 rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-white/10 shadow-2xl md:hidden animate-in fade-in slide-in-from-top-5">
          <Link href="/" onClick={() => setMobileMenuOpen(false)}>
            <Button variant="ghost" className="w-full justify-start text-sm hover:bg-white/10">
